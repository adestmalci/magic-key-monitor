        ...
        <div className="rounded-[30px] border border-zinc-200 bg-zinc-50/80 p-3.5 sm:p-4">
          ...
          <div className="mt-3 grid gap-3 sm:grid-cols-2">
            ...
            <div className="flex min-h-[168px] flex-col items-center justify-center rounded-[24px] border border-zinc-200 bg-white/80 p-4 text-center shadow-sm shadow-zinc-200/50">
              ...
              <div className="mt-2 text-base font-semibold text-zinc-900">{formatSyncTime(checkedAt)}</div>
              ...
              <div className="mt-4 w-full rounded-2xl border border-zinc-200 bg-zinc-50 px-3 py-3 text-left">
                <div className="flex items-center justify-between gap-3">
                  ...
                  <div className={classNames("rounded-full px-2.5 py-1 text-[10px] font-semibold", backgroundStateTone)}>
                ...
                <div className="mt-1 text-xs leading-5 text-zinc-600">
                  {backgroundSeen
                    ? `Last background sync ${formatSyncTime(backgroundCheckedAt)}. ${backgroundNote}`
                    : `Background sync aims for about every 5 minutes. ${backgroundNote}`}
                </div>
              </div>
            </div>
          </div>
